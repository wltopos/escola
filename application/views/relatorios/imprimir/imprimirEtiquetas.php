					...
					<div class="widget-content nopadding tab-content">
                        ...
                        if (
							...
							<div class="detalheProdutoEtiqueta">
								<div class="tipo_produtoEtiqueta">
									<?php $string = strtoupper($p->produtoDescricao); ?>
									<div>
										<strong>
							...
							<div class="titulo">
								<div class="tipo_produtoEtiqueta">
									...
									<div>
										<strong>
										<?php echo limitarTexto($string, $limite = 35); ?>
										</strong>
									</div>
								</div>
								</div>
								...
								<div class="barcodecell">
									<barcode code="<?= $p->codDeBarra ?>" text="0" type="<?= $this->input->get("etiquetaCode") ?>" size="1.4" disableborder="0"
									 class="barcode" />
								</div>
							</div>
