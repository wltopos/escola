            ...
            <div class="widget-box-new" style="height:100%">
                ...
                <div class="new-bottons">
                    <a href="<?php echo base_url(); ?>index.php/clientes/adicionar" class="card" title="Adicionar Clientes e Fornecedores" class="tooltip fade bottom in">
                        ...
                        <div>
                            <div class="cardName2"><?= $db_empresa->count_all('comercial_clientes'); ?></div>
                    ...
                    <a href="<?php echo base_url(); ?>index.php/produtos/adicionar" class="card" title="Adicionar Produtos" class="tip-bottom">
                        ...
                        <div>
                            <div class="cardName2"><?= $db_empresa->count_all('estoque_produtos'); ?></div>
                    ...
                    <a href="<?php echo base_url() ?>index.php/servicos/adicionar" class="card">
                        ...
                        <div>
                            <div class="cardName2"><?= $db_empresa->count_all('comercial_servicos'); ?></div>
                    ...
                    <a href="<?php echo base_url(); ?>index.php/os/adicionar" class="card" title="Adicionar Ordens de Serviço" class="tip-bottom">
                        ...
                        <div>
                            <div class="cardName2"><?= $db_empresa->count_all('comercial_os_clientes'); ?></div>
                    ...
                    <a href="<?php echo base_url(); ?>index.php/garantias" class="card">
                        ...
                        <div>
                            <div class="cardName2"><?= $db_empresa->count_all('comercial_garantias'); ?></div>
                    ...
                    <a href="<?php echo base_url() ?>index.php/vendas/adicionar" class="card" title="Adicionar Vendas" class="tip-bottom">
                        ...
                        <div>
                            <div class="cardName2"><?= $db_empresa->count_all('comercial_vendas'); ?></div>
                    ...
                    <tbody>
                        ...
                        if ($produtos != null) { ?>
                            <?php foreach ($produtos as $p) {
                                $estoque =  $this->produtos_model->converteMedida($p->estoque, $p->estoque_medida_id, 'D', $p->estoqueMinimo); ?>
                                <tr>
                                    <td>
                                        <?= $p->id_estoque_produto ?>
                                    </td>
                                    <td class="cli1">
                                        <?= $p->produtoDescricao ?>
                                    </td>
                                    ...
                                    <td class="ph3">
                                        <?= $estoque['textoEstoqueMinimoRS']; ?>
                                    </td>
                                    <td>
                                        <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'eProduto')) { ?>
                                            <a href="<?= base_url() ?>index.php/produtos/editar/<?= $p->id_estoque_produto ?>" class="btn-nwe3">
                                                <i class="bx bx-edit"></i>
                                            </a>
                                            <a href="#atualizar-estoque" role="button" data-toggle="modal" produto="<?= $p->id_estoque_produto ?>" estoque="<?= $p->estoque ?>" class="btn-nwe5" title="Atualizar Estoque">
...
<div id="calendarModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-header">
        ...
        <h3 id="myModalLabel">Status de lançamento detalhado</h3>
    </div>
    <div class="modal-body">
        <div class="span5" id="divFormStatusOS" style="margin-left: 0"></div>
        <h4><b>Lançamento:</b> <span id="modalId" class="modal-id"></span></h4>
        <div id="modalDescription" class="modal-Description"></div>
        <h5 id="modalFornecedor" class="modal-Fornecedor"></h5>
        <div id="modalTipo" class="modal-Tipo"></div>
        <div id="modalStatus" class="modal-Status"></div>
        <div id="modalObservation" class="modal-Observation"></div>
        ...
        <div id="modalValorDesconto" class="modal-ValorDesconto"></div>
        <div id="modalValorPago" class="modal-ValorPago"></div>
    ...
    $(document).ready(function() {
        ...
        var srcCalendar = new FullCalendar.Calendar(srcCalendarEl, {
            ...
            eventClick: function(info) {
                ...
                $('#modalIdVisualizar').attr("href", "<?php echo base_url(); ?>index.php/produtos/visualizar/" + eventObj.id);
                if (eventObj.editar) {
                    $('#modalIdEditar').show();
                    $('#linkExcluir').show();
                    $('#modalIdEditar').attr("href", "<?php echo base_url(); ?>index.php/produtos/editar/" + eventObj.id);
                ...
                $('#modalFornecedor').html(eventObj.fornecedor);
                $('#modalTipo').html(eventObj.tipo);
                $('#modalStatus').html(eventObj.status);
                $('#modalObservation').html(eventObj.observation);
                $('#modalDataInicial').html(eventObj.dataInicial);
                $('#modalDataFinal').html(eventObj.dataFinal);
                $('#modalValorTotal').html(eventObj.valorTotal);
                $('#modalValorDesconto').html(eventObj.valorDesconto);
                $('#modalValorPago').html(eventObj.valorPago);
