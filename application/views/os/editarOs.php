            ...
            <div class="widget-title" style="margin: -20px 0 0">
                ...
                <div class="buttons">
                    ...
                    <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'eOs')) {
                        ...
                        $troca = [$result->nomeCliente, $result->idOs, $result->status, 'R$ ' . ($result->desconto != 0 && $result->valor_desconto != 0 ? number_format($result->valor_desconto, 2, ',', '.') : number_format($totalProdutos + $totalServico, 2, ',', '.')), strip_tags($result->tipo_produto), ($emitente ? $emitente[0]->nome : ''), ($emitente ? $emitente[0]->telefone : ''), strip_tags($result->observacoes), strip_tags($result->defeito), strip_tags($result->laudoTecnico), date('d/m/Y', strtotime($result->dataFinal)), date('d/m/Y', strtotime($result->dataInicial)), $result->garantia . ' dias'];
                    ...
                    <div class="tab-content">
                        ...
                        echo 'selected';
                                    ...
                                    <div class="span6" style="padding: 1%; margin-left: 0">
                                        ...
                                        <textarea class="span12 editor" name="tipo_produto" id="tipo_produto" cols="30" rows="5"><?php echo $result->tipo_produto ?></textarea>
                                    </div>
                                    <div class="span6" style="padding: 1%; margin-left: 0">
                                        <label for="defeito">
                                            <h4>Defeito</h4>
