        ...
        <div class="collapse in accordion-body">
            <div class="widget-content">
                <table class="table table-bordered">
                    <tbody>
                    <div class="col" id="imageLogo" style=" justify-content: center; display: flex; ">
                    <img src="data:image/jpeg;base64,<?php echo $result->barcode ?>" alt="QRCode" style="width: 300px;">
                    </div>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo $result->id_comercial_cobranca; ?>
                            </td>
                        </tr>
