                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab1">
                            ...
                            <div class="span12" id="divCadastrarOs">
                                ...
                                <div class="span12" style="padding: 1%; margin-left: 0">
                                    <label for="tipo_produto">Descrição Produto/Serviço</label>
                                    <textarea class="span12 editor" name="tipo_produto" id="tipo_produto" cols="30" rows="5" disabled><?php echo $result->tipo_produto; ?></textarea>
                                </div>
