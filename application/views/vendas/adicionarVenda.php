                                    ...
                                    <div class="span12" style="padding: 1%">
                                        ...
                                        <div class="span5">
                                            ...
                                            <div class="addclient"><?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'aCliente')) { ?>
                                                    <a href="<?php echo base_url(); ?>index.php/clientes/adicionar" class="btn btn-success">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#cliente").autocomplete({
            source: "<?php echo base_url(); ?>index.php/AutoComplete/autoCompleteCliente",
            minLength: 1,
            close: function(ui) {
        ...
        $("#tecnico").autocomplete({
            source: "<?php echo base_url(); ?>index.php/AutoComplete/autoCompleteUsuario",
            minLength: 1,
            select: function(event, ui) {
