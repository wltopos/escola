            ...
            <div class="widget-content nopadding tab-content">
              ...
              <td colspan="9" >Nenhum lançamento encontrado</td>
                        ...
                        foreach ($results as $r) {
                            ...
                            $resultado_valor_desconto_desconto = $r->valor_ajuste;
                            $subtracao_valor_desconto = $r->valor_pago;
                            ...
                            echo '<tr>';
                            echo '<td>' . $r->id_financeiro_lancamento . '</td>';
                            ...
                            echo '<td> R$ ' . number_format($resultado_valor_desconto_desconto, 2, ',', '.') .' </td>'; // valor do desconto
                            echo '<td> R$ ' . number_format($subtracao_valor_desconto, 2, ',', '.') . '</td>'; // valor total  com o desconto
                            
                            echo '<td>';
                            if ($this->permission->checkPermission($this->session->userdata('permissao'), 'eLancamento')) {
                                echo '<a href="#modalEditar" style="margin-right: 1%" data-toggle="modal" role="button" idLancamento="' . $r->id_financeiro_lancamento . '" descricao="' . $r->descricao . '" valor="' . $r->valor . '" vencimento="' . date('d/m/Y', strtotime($r->data_vencimento)) . '" pagamento="' . date('d/m/Y', strtotime($r->data_pagamento)) . '" baixado="' . $r->baixado . '" cliente="' . $r->cliente_fornecedor . '" formaPgto="' . $r->forma_pgto . '" tipo="' . $r->tipo . '" observacoes="' . $r->observacoes . '" valor_desconto_editar="' . $resultado_valor_desconto_desconto .  '" valor_pago="' . $subtracao_valor_desconto .'" usuario="' . $resultFuncionario->nome . '" class="btn-nwe3 editar" title="Editar OS"><i class="bx bx-edit"></i></a>';
                            }
                            if ($this->permission->checkPermission($this->session->userdata('permissao'), 'dLancamento')) {
                                echo '<a href="#modalExcluir" data-toggle="modal" role="button" idLancamento="' . $r->id_financeiro_lancamento . '" class="btn-nwe4 excluir" title="Excluir OS"><i class="bx bx-trash-alt"></i></a>';
                            }
                    ...
                    <?php if(isset($totals)): ?>
                        ...
                        <tr>
                            ...
                            <td colspan="3" style="text-align: left;">
                                <strong>R$ <?php echo number_format($totals['valor_pago_receitas_pagas'] - $totals['valor_pago_despesas_pagas'], 2, ',', '.') ?></strong>
                            </td>
                        </tr>
                    <?php endif ?>
                    ...
                    <?php if(isset($estatisticas_financeiro)): ?>
                        ...
                        <tr>
                      <td colspan="6" style="text-align: left; color: green">Total Receitas (Pagas): R$ <?php echo number_format( $estatisticas_financeiro->total_valor_pago_receitas, 2, ',', '.'); ?></td>
                      </tr>
                      <tr>
                      <td colspan="6" style="text-align: left; color: red">Total Despesas (Pagas): R$ <?php echo number_format( $estatisticas_financeiro->total_valor_pago_despesas, 2, ',', '.'); ?></td>
                      </tr>
                      <tr>
                      <td colspan="6" style="text-align: left;"><strong>Total Receitas (-) Despesas = Saldo Líquido: R$ <?php $sub_receita_despesa = $estatisticas_financeiro->total_valor_pago_receitas - $estatisticas_financeiro->total_valor_pago_despesas; echo number_format($sub_receita_despesa, 2, ',', '.') ?></strong></td>
                      </tr>
                      <tr>
                      <td colspan="6" style="text-align: left;">Total Receitas (+) Despesas: R$ <?php $soma_receita_despesa = $estatisticas_financeiro->total_valor_pago_receitas + $estatisticas_financeiro->total_valor_pago_despesas; echo number_format($soma_receita_despesa, 2, ',', '.') ?></td>
                      </tr>
                      <tr>
                      <td colspan="6" style="text-align: left;">Total Receitas Pendentes: R$ <?php  echo number_format( $estatisticas_financeiro->total_valor_receitas_pendentes, 2, ',', '.'); ?></td>
                      </tr>
                      <tr>
                      <td colspan="6" style="text-align: left;">Total Despesas Pendentes: R$ <?php echo number_format( $estatisticas_financeiro->total_valor_despesas_pendentes, 2, ',', '.'); ?></td>
                      </tr>
                      <tr>
                      <td colspan="6" style="text-align: left;">Total de Receitas Pendentes (-) Despesas Pendentes: R$ <?php $sub_recpendente_despependente = $estatisticas_financeiro->total_valor_receitas_pendentes - $estatisticas_financeiro->total_valor_despesas_pendentes; echo number_format( $sub_recpendente_despependente, 2, ',', '.')?></td>
                      </tr>
                      <tr>
                      <td colspan="6" style="text-align: left;"><strong>Total de Receitas Pendentes (+) Despesas Pendentes: R$ <?php $sub_recpendente_despependente = $estatisticas_financeiro->total_valor_receitas_pendentes + $estatisticas_financeiro->total_valor_despesas_pendentes; echo number_format( $sub_recpendente_despependente, 2, ',', '.')?></strong></td>
                      </tr>
                      <tr>
                      <td colspan="6" style="text-align: left;">Total de Descontos aplicados á lançamentos de receitas Pagos: R$ <?php echo number_format( $estatisticas_financeiro->total_descontos_pagos_receita, 2, ',', '.'); ?></td>
                      </tr>
                      <tr>
                      <td colspan="6" style="text-align: left;">Total de Descontos aplicados á lançamentos de receitas Pendentes: R$ <?php echo number_format( $estatisticas_financeiro->total_valor_descontos_receita_pendentes, 2, ',', '.'); ?></td>
                      </tr>
                      <tr>
                      <td colspan="6" style="text-align: left;"><strong>Total de descontos aplicados a receitas (pagos + pendentes): R$ <?php $soma_descontos_pagos = $estatisticas_financeiro->total_descontos_pagos_receita + $estatisticas_financeiro->total_valor_descontos_receita_pendentes; echo number_format( $soma_descontos_pagos, 2, ',', '.')?></strong></td>
                      </tr>
                      <tr>
                      <td colspan="6" style="text-align: left;">Total de Receitas sem descontos aplicados (pagos): R$ <?php echo number_format( $estatisticas_financeiro->total_receitas_pagas_sem_desconto, 2, ',', '.'); ?></td>
                      </tr>
                      <tr>
                      <td colspan="6" style="text-align: left;">Total de Despesas sem descontos aplicados (pagos): R$ <?php echo number_format( $estatisticas_financeiro->total_pagas_despesas_sem_desconto, 2, ',', '.'); ?></td>
                      </tr>
                      <?php endif ?>
                    </tfoot>
                </table>
...
<div id="modalReceita" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form id="formReceita" action="<?php echo base_url() ?>index.php/financeiro/adicionarReceita" method="post">
        ...
        <div class="span4">  
          ...
          <input class="span12 money" id="valor_desconto" readOnly="true" title="Não altere este campo" type="text" name="valor_desconto" value="<?php echo number_format("0.00",2,',','.') ?>" readonly/>
        </div>
...
<script type="text/javascript">
    ...
    function mostrarValoresEditar() {
		if (document.getElementById('valorEditar').value == "" || document.getElementById('descontos_editar').value == "" || document.getElementById('descontoEditar').value == ""){
            ...
            document.getElementById('descontoEditar').value = total.toFixed(2);
			}
	}
    ...
    jQuery(document).ready(function($) {
        ...
        $(document).on('click', '.editar', function(event) {
            ...
            $("#descontos_editar").val($(this).attr('valor_desconto_editar'));
           $("#descontoEditar").val($(this).attr('valor_pago'));
