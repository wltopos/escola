...
<head>
  ...
  <title>Sistema de Controle de Loja (SCL) | <?= $this->renderSection('titulo') ?> </title>
  ...
  <!-- Estilos de cada view para extender o layout -->
...
<body>
    ...
    <div class="page-content">
      ...
      <section class="no-padding-top no-padding-bottom">
        ...
        <div class="container-fluid">
          ...
          <!-- Conteudo a ser renderizado no layout -->
      ...
      <footer class="footer">
        <div class="footer__block block no-margin-bottom">
          <div class="container-fluid text-center">
            ...
            <p class="no-margin-bottom"><?= date('Y'); ?> &copy; WL Topos. @lucasrocha <a target="_blank" href="https://github.com/lrochawl">Sistemas de Automação Empresarial</a>.</p>
          </div>
        </div>
      </footer>
    </div>
  ...
  <!-- Scripts a ser incluidos e renderizados no layout -->
